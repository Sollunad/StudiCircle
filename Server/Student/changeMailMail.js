...
module.exports = {
    send: function (oldMail, newMail) {
        ...
        let htmlNewMail = '<html lang="de-DE">\n' +
            ...
            '<body>\n' +
                '<p>\n' +
                    'You requested the change of your Mail. Please confirm the address by clicking the following link <a href="http://localhost:8080/' + resetId + '/changeMail">Confirm mail address</a><br/>\n' +
